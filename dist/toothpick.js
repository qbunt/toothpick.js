...
(function (exports) {
     ...
     */
    if (!isNode) exports.clearCookie = function (cookieName) {
     ...
     */
    if (!isNode) exports.getAbsolutePosition = function (el) {
...
})(typeof exports === 'undefined' ? undefined['toothpick'] = {} : exports);
